...
ANATOMY = {
    ...
    "queen-alexandras-birdwing": "large male birdwing (Ornithoptera alexandrae) held at a gentle 3/4 dorsal tilt with the long tapered forewings swept downward and curved inward (NOT spread flat corner-to-corner); forewings mostly black crossed by an iridescent yellow-green upper band and a blue-green lower band with a long black oval patch; broader scalloped hindwings emerald-green to turquoise divided by strong black radiating veins with broad black margins; long bright yellow segmented abdomen, black thorax, thin curved black antennae; drawn medium-sized (about 60 percent of frame) with even cream margin so the whole wingspan stays comfortably inside the circle",
    ...
    "deaths-head-hawkmoth": "a large heavy-bodied hawkmoth shown with wings held in a compact swept-back resting triangle rather than spread wide, forewings mottled dark brown and black, hindwings warm ochre-yellow banded with black, and the famous pale skull-shaped marking on the furry brown thorax as the focal feature, short feathered antennae and legs tucked close; deliberately draw the moth small and compact with wings angled inward so the whole insect and both wingtips stay well inside the circle with even breathing room",
