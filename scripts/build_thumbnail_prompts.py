...
ANATOMY = {
    ...
    "queen-alexandras-birdwing": "enormous butterfly held at a gentle 3/4 dorsal tilt with wingtips angled downward and curved inward (NOT spread flat corner-to-corner), broad rounded forewings velvet black with cream and golden-yellow zigzag bands, hindwings rich green with gold central patches, plump cream-yellow body, drawn SMALL in frame with generous cream margin so the wide wingspan stays well inside the circle",
